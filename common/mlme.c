    ...
    */
    ...
    for(i=0; i<SupRateLen; i++)
    {
        ...
        case 2:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 0;
        ...
        case 4:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 1;
        ...
        case 11:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 2;
        ...
        case 22:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 3;

            break;

        case 12:
            Rate = RATE_6;	/*if (pSupRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 4;
            break;

        case 18:
            Rate = RATE_9;

            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 5;

            break;

        case 24:
            Rate = RATE_12;	/*if (pSupRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 6;
            break;

        case 36:
            Rate = RATE_18;

            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 7;

            break;

        case 48:
            Rate = RATE_24;	/*if (pSupRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 8;
            break;

        case 72:
            Rate = RATE_36;

            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 9;
        ...
        case 96:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 10;
        ...
        case 108:
            ...
            if(pSupRate[i] & 0x80) BasicRateBitmap |= 1 << 11;
    ...
    for(i=0; i<ExtRateLen; i++)
    {
        ...
        case 2:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 0;
        ...
        case 4:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 1;
        ...
        case 11:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 2;
        ...
        case 22:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 3;

            break;

        case 12:
            Rate = RATE_6;	/*if (pExtRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 4;
            break;

        case 18:
            Rate = RATE_9;

            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 5;

            break;

        case 24:
            Rate = RATE_12;	/*if (pExtRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 6;
            break;

        case 36:
            Rate = RATE_18;

            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 7;

            break;

        case 48:
            Rate = RATE_24;	/*if (pExtRate[i] & 0x80)*/  BasicRateBitmap |= 1 << 8;
            break;

        case 72:
            Rate = RATE_36;

            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 9;
        ...
        case 96:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 10;
        ...
        case 108:
            ...
            if(pExtRate[i] & 0x80) BasicRateBitmap |= 1 << 11;
